...
public class Tab2Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mstorageReference = FirebaseStorage.getInstance().getReference("UserUploads");

        mRef = new Firebase("https://minor2-d5d31.firebaseio.com/");
        mChildNameRef = mRef.child("UserImages");
    ...
    private void uploadFile(){
        ...
        if(mImageuri!=null){
            final StorageReference fileReference = mstorageReference.child("IDCARD"+System.currentTimeMillis()
            ...
            storageTask = fileReference.putFile(mImageuri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            handler.postDelayed(new Runnable() {
                                ...
                                //Upload upload = new Upload(sap_id, fileReference.getDownloadUrl().toString());
                                ...
                                childOfChildFileName.setValue("File 1 "+System.currentTimeMillis());
                                childOfChildUrl.setValue(fileReference.getDownloadUrl().toString());
                                sp = getActivity().getSharedPreferences("Uploaded", Context.MODE_PRIVATE);
                                SharedPreferences.Editor editor = sp.edit();
                                editor.putString("Done", "Ok");
                                editor.apply();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toasty.error(getContext(),"Error in Loading",Toasty.LENGTH_LONG).show();
